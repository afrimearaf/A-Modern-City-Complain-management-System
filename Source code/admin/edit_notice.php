                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-4 align-self-center">
                        <div class="text-end upgrade-btn">
                            <a href="notices.php"
                                class="btn btn-danger d-none d-md-inline-block text-white" target="_blank">Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
...
-->
                    ...
                    <?php 
                        ...
                        if(isset($_GET['edit'])){
                            ...
                            $notice=$_GET['edit'];
                            $query="SELECT * FROM notice WHERE notice_id = {$notice}";
                            $get_notices = mysqli_query($conn, $query);

                            if(!$get_notices){
                                die("Query Failed". mysqli_error($conn));
                            }
                            while($row=mysqli_fetch_assoc($get_notices)){
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $query = "UPDATE `notice` SET `topic`='{$subject}',`info`='{$description}'WHERE notice_id = {$notice}";

                            $update_notice_query= mysqli_query($conn,$query);
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" action="" method="post">
                                    <div class="form-group mt-3">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Health and Family"
                                                class="form-control ps-0 form-control-line" name="subject" value="<?php echo $topic; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <div class="col-md-12">
                                            <textarea name="description" rows="5" class="form-control ps-0 form-control-line" value=""><?php echo $info; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group mt-3"> 
                                        <div class="col-sm-12 d-flex">
                                            <button class="btn btn-success mx-auto mx-md-0 text-white px-3 py-2" name="submit" style="text-transform:uppercase;">Submit</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
