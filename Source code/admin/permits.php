            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Permits</h3>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table user-table table-hover wrap table-responsive">
                                        <thead>
                                            <tr>
                                                <th class="border-top-0">Permit ID</th>
                                                <th class="border-top-0">Post ID</th>
                                                <th class="border-top-0">Recommendation</th>
                                                ...
                                                <th class="border-top-0">Mark As Done</th>
                                            </tr>
                                        </thead>
                                        <tbody style="overflow-x:hidden;">
                                            <?php 
                                                ...
                                                $query="SELECT * FROM solution ORDER BY end_time ASC";
                                            ...
                                            echo "<tr>";
                                                ...
                                                $get_state_query = mysqli_query($conn, $sql);
                                                while($row=mysqli_fetch_assoc($get_state_query)){
                                                    $state=$row['state'];
                                                    echo "<td>$state</td>";
                                                }
                                                echo "<td><a href='function.php?per_id=$solution_id'><i class='fas fa-check-circle'></i></a> </td>";
                                             echo "<tr>";
                                            } ?>
