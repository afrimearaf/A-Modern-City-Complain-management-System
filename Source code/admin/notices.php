            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Notices</h3>
                                    ...
                                    <table class="table user-table table-hover wrap table-responsive">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">Unapprove</th>
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $query="SELECT * FROM notice ORDER BY date ASC";
                                                ...
                                                while($row=mysqli_fetch_assoc($get_notices)){
                                                    ...
                                                    echo "<td>$date</td>"; 
                                                    echo "<td>$status</td>"; 
                                                    echo "<td><a href='function.php?approve=$notice_id'>Approve</a> </td>";
                                                    echo "<td><a href='function.php?unapprove=$notice_id'>Unapprove</a> </td>";
                                                    echo "<td><a href='edit_notice.php?edit=$notice_id'>Edit</a> </td>";
                                                    echo "<td><a href='function.php?delete_notice=$notice_id'>Delete</a> </td>";
                                                    echo "<tr>";
                                                } ?>
