    ...
    <div class="container-fluid">
        <main class="tm-main">
            ...
            <div class="row tm-row tm-mb-40">
                <div class="col-12">                    
                    <div class="mb-4">
                        <h2 class="pt-2 tm-mb-40 tm-color-primary tm-post-title">About Sohure-শহুর</h2>
                        <p>
                            You can immediately download 
                                from Template website for 100% free of charge. Etiam vehicula, tortor ac eleifend tincidunt, diam neque pellentesque ipsum, 
