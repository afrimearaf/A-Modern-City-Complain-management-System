            ...
            <div class="row tm-row">
                <div class="col-lg-8 tm-post-col">
                    <div class="tm-post-full">                    
                        ...
                        <!-- Comments -->
                        <div>
                            <h2 class="tm-color-primary tm-post-title">Soltuion State</h2>
...
-->
                                    ...
                                    $user_own = $_SESSION['user_id'];
//                                    echo $state;
                                    
                                    
                                    if($user_id == $user_own && $state == 0) {
                                        echo "<p>
                                        আপনার প্রস্তাবিত সমস্যাটি এখনো মাননীয় মেয়রের নিকট প্রস্তাবিত হয়নি । দয়া করে ধর্য্য সহকারে অপেক্ষা করুন । ধন্যবাদ
                                        </p>";
                                    }
                                    
                                    else if($user_id == $user_own && $state == 1) {
                                        echo "<p>
                                        আপনার সমস্যাটি মাননীয় মেয়রের নিকট প্রস্তাবিত হয়েছে এবং উনার অনুমতির অপেক্ষায় রয়েছে । দয়া করে ধর্য্য সহকারে অপেক্ষা করুন । ধন্যবাদ
                                        </p>";
                                    }
                                    else if($user_id == $user_own && $state == 2) {
                                        
                                        $sql = "SELECT * FROM `solution` WHERE post_id = '$post_id'";
                                        $progress_query = mysqli_query($conn, $sql);
                                        ...
                                        echo "<p>
                                        আপনার সমস্যাটি মাননীয় মেয়রের দ্বারা <strong>$budget</strong> টাকার বাজেট প্রস্তাবিত হয়েছে । সমস্যাটি সমাধানের কাজের শুরু ও শেষের দিন ধার্য্য করা হয়েছে <strong>$start_time</strong> হইতে <strong>$end_time</strong> তারিখ । দয়া করে ধর্য্য সহকারে অপেক্ষা করুন । ধন্যবাদ
                                        </p>";
                                    }
                                    else if($user_id == $user_own && $state == 3) {
                                        echo "<p>
                                        আপনার সমস্যাটির সমাধান মাননীয় মেয়রের তত্ত্ববধানে সম্পন্ন হয়েছে । ধন্যবাদ 
                                        </p>";
                                    }
                                    else {
                                        echo "<p>
                                        আপনি এই সমস্যাটির সমাধানের তথ্য দেখার যোগ্য নন । ধন্যবাদ 
                                        </p>";
                                    }
