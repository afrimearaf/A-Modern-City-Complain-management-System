        ...
        <div class="tm-header-wrapper">
            ...
            <nav class="tm-nav" id="tm-nav">
                <ul>
                    ...
                    <li class="tm-nav-item  active"><a href="own.php" class="tm-nav-link">
    ...
    <div class="container-fluid">
        <main class="tm-main">
            <!-- Search form -->
                ...
                <div class="col-6">
                    <form method="post" action="search.php" class="form-inline tm-mb-80 tm-search-form">                
                        <input class="form-control tm-search-input" style="width:300px;" name="query" type="text" placeholder="Search..." aria-label="Search">
            ...
            <div class="row tm-row">
                ...
                $query="SELECT * FROM posts WHERE user_id = '$user_own' ORDER BY date ASC";
