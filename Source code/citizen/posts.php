        ...
        <main class="tm-main">
            ...
            <div class="row tm-row tm-mb-45">
                <div class="col-12">
                    ...
                    <h2 class="text-center tm-color-primary tm-post-title tm-mb-40" style="font-size:40px;">আপনার সমস্যা সম্পর্কে বর্ণনা করুন</h2>
                </div>                
            </div>
            <div class="row tm-row tm-mb-120">
                ...
                <div class="col-lg-12 tm-contact-left">
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        $query = "INSERT INTO `posts`(`user_id`, `user_name`, `ward_no`, `address`, `subject`, `description`, `category`, `post_image`, `date`,  `state`) VALUES ('{$user_id}','{$user_name}','{$ward_no}','{$address}','{$subject}','{$description}','{$category}','{$image}', now(), 0)";
                    ...
                    ?>
                    <form method="POST" action="posts.php" class="mb-5">                        
                        <div class="form-group row mb-4">
                            <label for="name" class="col-sm-3 col-form-label text-right tm-color-primary">ঠিকানা: </label>
                            <div class="col-sm-9">
                                <input class="form-control mr-0 ml-auto" name="address" id="address" type="address" required>                            
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="subject" class="col-sm-3 col-form-label text-right tm-color-primary">বিভাগ:</label>
                            <div class="col-sm-9 select">
                                <select class="form-control mr-0 ml-auto" name="category" required>
                        ...
                        <div class="form-group row mb-4">
                            <label for="image" class="col-sm-3 col-form-label text-right tm-color-primary">ছবি: </label>
                            <div class="col-sm-9">
                                <input class="form-control mr-0 ml-auto" name="image" id="image" type="file" required>
                            </div>
                        </div>
